...
<div class="row">
    ...
    if ($location_count == 0) {
        ...
        foreach ($locations as $location) { ?>
            <div class="col-md-4 col-sm-5 col-xs-12 col-sm-offset-1 col-sm-offset-2 col">
                <div class="card card-block">
                    <h3 class="card-title"><?php echo $location['state_name']; ?> <span class="small"><?php echo strtoupper($location['location_id']); ?></span></h3>
                    <p class="card-text"><b>Address:</b> <?php echo $location['location_address']; ?></p>
                    <p class="card-text"><b>Postcode:</b> <?php echo $location['poscode_number']; ?></p>
                    <p class="card-text"><b>City:</b> <?php echo $location['city_name']; ?></p>
                    <p class="card-text"><b>No. of Offer:</b> <?php echo $location['intern_no']; ?></p>
                    <p class="card-text"><b>No. of Interns:</b> <?php echo $location['stud_num']; ?></p>
                    <a href="<?php echo BASE_URL . 'ind/viewOffers.php?location=' . $location['location_id']; ?>"
                       class="btn btn-primary">View Offers</a>
                    <a href="<?php echo BASE_URL . 'ind/editAddress.php?location=' . $location['location_id']; ?>" class="btn btn-success">Edit Address</a>
                </div>
            </div>
            <?php
        }
